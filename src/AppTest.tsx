// Test App with AnalyticsProvider to debug the issue
...
// App Component with AnalyticsProvider test
const App = () => (
  <ErrorBoundary>
    <SecurityHeaders />
    <AnalyticsProvider>
          ...
          <ApolloProvider client={client}> 
            <WordPressProvider>
              <TooltipProvider>
                ...
                <BrowserRouter>
                  <CartProvider>
                    {/* Commenting out direct analytics since AnalyticsProvider should handle them */}
                    {/* <GoogleAnalytics /> */}
                    {/* <GoogleTagManager /> */}
